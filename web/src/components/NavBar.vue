    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <router-link :class="route_name == 'record_index' ? 'nav-link active':'nav-link' " :to="{name:'record_index'}" @click="click_to_record">对局列表</router-link>
                </li>
                <li class="nav-item">
...
export default {
    ...
    setup(){
        ...
        const click_to_record = () => {
            store.commit('updateSearchUsername', '');
        }
