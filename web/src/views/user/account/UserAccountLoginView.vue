         ...
         <div class="row justify-content-md-center">
            <div class="col-3">
                <form @submit.prevent='login' class="login">
                    ...
                    <div :class="'alert alert-danger '+ alertClass" role="alert" style="height:5vh;line-height:5vh;margin:0px auto;">
                        <strong>{{message}}</strong>
                    </div>
                    <div class="enterBut">
                        <input type="submit"  value="登  录" style="border-bottom:0px;margin-top: 0px;">
                    </div>
                    </div>
                </form>
            </div>
        ...
        const login = () => {
            ...
            store.dispatch('login', {
                ...
                error(){
                    ...
                    frameClass.value = 'loginFrame-error';
...
<style scoped>
        ...
        * {
        ...
        .loginFrame .enterBut {
            ...
            height: 50px;
            border-radius: 50px;
            background-image: linear-gradient(to right, #59c2c5, #59c2c5);
            text-align: center;
            padding-top: 10px;
            box-sizing: border-box;
            font-size: 20px;
