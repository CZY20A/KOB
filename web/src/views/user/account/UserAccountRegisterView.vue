                ...
                <form @submit.prevent='register'>
                    ...
                    <div>
                        <label>
                            ...
                            <span>确认密码</span>
                            <input  placeholder="   ConfirmPassword" type="password" v-model="confirmPassword">
                        </label>
                    </div>
                    ...
                    <div class="enterBut">
                        <input type="submit"  value="注  册" style="border-bottom:0px;margin-top: 0px;">
                    </div>
                    </div>
                </form>
</template>
...
export default{
    ...
    setup(){
        ...
        const register = () => {
            ...
            $.ajax({
                type:"POST",
                url:"http://172.18.90.64:3000/api/user/account/register/",
                data:{
